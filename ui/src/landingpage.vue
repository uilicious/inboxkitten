		...
		<div class="info-guide mx-a my-0 p-2" style="max-width: 1240px; ">
			<div class="pure-g mx-a" style="max-width: 1000px; background: #fbc02d4f; padding-top: 1em;">
				<div class="pure-u-1-1">
						...
						<p><a href="https://uilicious.com/blog/psa-inboxkitten-will-be-blocking-no-reply-google/">We block "no-reply@google" to prevent abuse on our platform, see more details on our blog post</a></p>
					</section>
				</div>
			</div>
